...
public class Polish extends Language{
    ...
    public Polish() {
        ...
        yml.addDefault(Messages.COMMAND_STATS_PLAYER_NOT_ONLINE, "{prefix}&cNie ma takiej osoby online!");
        ...
        yml.addDefault(Messages.CHAT_TEAM_TIP_NEWBIE, "&eWysylasz tylko do wlasnej druzyny. Napisz &6! &ena poczatku, aby wyslac globalnie.");
        ...
        yml.addDefault(Messages.INTERACT_CHEST_CANT_OPEN_TEAM_ELIMINATED, "&cNie mozesz otworzyc tej skrzyni, bo ta druzyna jeszcze nie zostala wyeliminowana!");
